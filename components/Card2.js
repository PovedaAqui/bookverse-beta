    ...
    return (
        <div className="flex justify-center relative m-2 lg:mx-0.5 lg:my-2">
            <div className="rounded-lg shadow-lg bg-white max-w-sm lg:max-w-xs">
                <a href="javascript:void(0)" onClick={()=> router.push(`/listing/${listingId}`)}>
                ...
                <div className="relative p-6">
                    ...
                    <div className='flex items-center'>
                        ...
                        <span className="text-xl font-bold text-gray-900 mt-0 ml-1">{price === undefined? "..." : price}</span>
                        <span className="text-xl font-bold text-gray-700 mt-0 ml-1">{`- ${maticToUsd} USD`}</span>
                        <span className="text-xl font-bold text-gray-700 mt-0 ml-auto">{pair === undefined? "..." : pair}</span>
                    </div>
                </div>
            </div>
        </div>
